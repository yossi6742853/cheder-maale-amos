...
var src_default = {
  async fetch(request, env) {
    ...
    if (!part?.data) return new Response("no audio :: " + JSON.stringify(data).slice(0, 400), { status: 502, headers: cors() });
...
// .wrangler/tmp/bundle-wfCEOC/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wfCEOC/middleware-loader.entry.ts
